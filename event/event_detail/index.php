            ...
            <div class="mt-4">
                ...
                <div class="bg-white rounded-lg shadow p-4 mt-2 w-full">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="../checkout/?order_id=<?php echo $event['order_id']; ?>" class="text-center focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
