        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
            ...
            <div class="bg-white rounded-lg p-4 shadow">
                ...
                <div class="produk-container">
                    <button onclick="kurangiJumlah()" class="tombol-aksi">-</button>
                    <input type="text" id="jumlahProduk" value="0" class="input-jumlah">
                    <button onclick="tambahJumlah()" class="tombol-aksi">+</button>
                </div>
                <style>
                .produk-container {
                    display: flex;
