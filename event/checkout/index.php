...
<body class="dark:bg-gray-900 text-gray-700 dark:text-gray-300">
            ...
            <div class="card p-5 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg shadow">
                ...
                <form method="post">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="text" name="harga" value="<?php echo $harga * $jumlahProduk; ?>" class="p-2 w-25 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <script>
        let jumlahProduk = parseInt(document.getElementById('jumlahProduk').value);
