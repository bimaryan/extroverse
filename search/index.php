        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-1 px-3">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <div class="flex items-center space-x-4">
                            ...
                            <form method='get'>
                                <div class="flex md:order-2">
                                    <div class="relative hidden md:block">
                                        ...
                                        <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" id="search" name="Mencari" placeholder="Cari event...">
                                    </div>
                                </div>
                            </form>
                        </a>
                        <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-2 focus:ring-purple-900" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    ...
                    <?php endif; ?>
                    <button id="theme-toggle" type="button" class="text-white bg-purple-900 focus:outline-none focus:ring-2 rounded-lg text-sm p-2.5">
                ...
                <button data-collapse-toggle="navbar-user" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 bg-purple-900 rounded-lg md:hidden focus:outline-none focus:ring-2" aria-controls="navbar-user" aria-expanded="false">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul class="flex flex-col font-medium rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row bg-purple-900">
                    <li>
                        <a>
                            <form method="get">
                                <div class="relative md:hidden mb-2">
                                    ...
                                    <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
                                </div>
                            </form>
                        </a>
                    </li>
